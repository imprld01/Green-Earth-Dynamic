				...
				<div class="container">	
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="show_my_article_list.php"><?php echo $login_session; ?></a></li>
		...
		<div id = "treeAreaShow">
            <section class="container">
			  ...
			  if(isset($_SESSION['login_user'])){
				...
				echo "<p>你的帳號是 ".$_SESSION['login_user'];
				...
				$query=("insert into seed(id,level,exp) value(?,?,?)");
				
			
		
				$res=$db->prepare($query);
				$res->execute(array($user,0,0));
